...
function About{
    [System.Windows.MessageBox]::Show( "Program Scyzoryk powstał w celu szybkiego rozwiązywania prostych i częstych problemóww w codziennej pracy.
...
Wersja 1.0.1: dodano opcjê restartowania aplikacji Płatnik, zakładki Linki oraz Konta.","O porgramie", "OK", "Information")
}
...
w celu zapobiegniêcia ich całkowitemu usuniêciu.
	
Login do stacji roboczej: Login zawsze składa siê z Twojego nazwiska i imienia, bez polskich znaków, rozdzielonymi kropk¹.
Przykład: kowalski.jan

Login do SyriuszSTD: Login składa się z trzech pierwszych liter Twojego imienia i nazwiska oraz czterech losowo wybranych cyfr. Login i hasło nadawane jst przez system Broker i podane na Twojego maila podanego przy tworzeniu konta.
Przykład: jankow1234

Hasła do domeny jak i aplikacji SyriuszSTD muszą składać się
z minimum ośmiu znaków, małej i dużej litery, cyfry oraz znaku specjalnego. Hasło zmieniane jest co 30 dni i nie mo¿e powtarzaæ się w przeci¹gu 12 miesięcy."
